...
% define colours
\definecolor{bordercolour}{HTML}{ff9933} % green
...
\begin{document}
  ...
  \begin{tikzpicture}[remember picture,overlay,inner sep=0pt]
    ...
    % \draw[fill=bordercolour!40,draw=bordercolour] (current page.center) ++(-\paperwidth/2+\edgemargin,\paperheight/2-\edgemargin) rectangle ++(\paperwidth-2*\edgemargin,-\paperheight+2*\edgemargin);
...
% - \paperwidth/2 + \edgemargin+ \paperheight/2 - \edgemargin - \qrwidth/2
    ++ (\paperwidth/2 - \edgemargin - \qrwidth/2, 0) 
    node (helper qr) {};

    \node[anchor=east] at (helper qr) 
        {\qrcode[level=M,height=\qrwidth]{BEGIN:VCARD
        VERSION:3.0
        N:Matthew;Sheehan;;Mr.
        FN:Mr. Matthew Sheehan
        ...
        BDAY:19910206
        ADR;TYPE=WORK,PREF:;;313 S. High Street Suite 200;Akron;OH;44308;USA
        END:VCARD}};
